...
class SixtyDaysFragment : Fragment() {
    private lateinit var binding: FragmentSixtyDaysBinding
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_sixty_days, container, false)
